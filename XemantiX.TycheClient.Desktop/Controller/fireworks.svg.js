 ...
 * MIT (X11) Licensed
 *
 * Nicole Carabut - custom patching + modularization
 *
 */
...
//        this.ctx.clearRect(0, 0, this.canvaswidth, this.canvasheight);
        ...
        if( (firecount == 0) && (this.OnAnimationEnded != null) )
        {
            clearTimeout( this.gameloop );
            setTimeout( this.OnAnimationEnded, 2000 );
        }
    },
