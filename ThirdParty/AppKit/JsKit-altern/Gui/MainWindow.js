...
JsKit.Gui.MainWindow.prototype.buildContent = function()
{
    ...
    // FIXME: add a bool flag to not create if there is a such tag already
    JsKit.Dom.createNodeByPath( mainWindowTag );

    this._domNode = new JsKit.Dom.Node( mainWindowTag );
    this._domNode.setAttribute( "id", "pageContent" );
    this._domNode.setAttribute( "class", "pageContent" );
}
